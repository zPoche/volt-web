...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.error) {
      return (
        <div className="volt-atmosphere flex min-h-dvh flex-col justify-center px-6 py-12 text-foreground">
          <div className="mx-auto w-full max-w-lg">
            ...
            <pre className="volt-glass mt-5 overflow-x-auto rounded-xl p-4 font-mono text-sm leading-relaxed text-muted-foreground">
